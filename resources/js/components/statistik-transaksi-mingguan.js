...
const statistikTransaksiMingguan = () => {
    const ctx = document.getElementById("statistik-transaksi-mingguan");
    if (!ctx) return;
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        htmlLegend: {
                            ...
                            containerID: "statistik-transaksi-mingguan-legend",
                        },
                        tooltip: {
                            callbacks: {
...
export default statistikTransaksiMingguan;
