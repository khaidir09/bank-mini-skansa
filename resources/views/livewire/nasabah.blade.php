<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            ...
            {{-- <a href="{{ route('nasabah-export') }}" class="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300">
                Ekspor Nasabah
            </a>

            <div x-data="{ imporOpen: false }">
                <button class="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" @click.prevent="imporOpen = true" aria-controls="impor-modal">
                    Impor Nasabah
                </button> 
                <!-- Modal backdrop -->
                <div
                ...
                <div
                    ...
                    x-cloak
                >
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-auto max-w-lg w-full max-h-full" @keydown.escape.window="imporOpen = false">
                        <!-- Modal header -->
                        <div class="px-5 py-3 border-b border-gray-200 dark:border-gray-700/60">
                            <div class="flex justify-between items-center">
                                <div class="font-semibold text-gray-800 dark:text-gray-100">Impor Nasabah Baru</div>
                                    <button class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400" @click="imporOpen = false">
                        ...
                        <!-- Modal content -->
                        <form method="post" action="{{ route('impor-nasabah') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="name">File <span class="text-rose-500">*</span></label>
                                        <input type="file" name="file" id="file" class="form-input w-full px-2 py-1 @error('nomor_induk') is-invalid @enderror" required>
                                        @error('file')
                            ...
                            <div class="px-5 py-4">
                                <div class="flex flex-wrap justify-end space-x-2">
                                    <button class="btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" @click="imporOpen = false">Batal</button>
                                    <button type="submit" class="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Impor</button>
                                </div>
                            </div>
                        </form>
                    </div>
             ...
             <div x-data="{ rekeningOpen: false }">
                <button class="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" @click.prevent="rekeningOpen = true" aria-controls="rekening-modal">
                    Impor Rekening
                </button> 
                <!-- Modal backdrop -->
                <div
                ...
                <div
                    ...
                    x-cloak
                >
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-auto max-w-lg w-full max-h-full" @keydown.escape.window="rekeningOpen = false">
                        <!-- Modal header -->
                        <div class="px-5 py-3 border-b border-gray-200 dark:border-gray-700/60">
                            <div class="flex justify-between items-center">
                                <div class="font-semibold text-gray-800 dark:text-gray-100">Impor Rekening Baru</div>
                                    <button class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400" @click="rekeningOpen = false">
                                    <div class="sr-only">Close</div>
                                    <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16">
                                        <path d="M7.95 6.536l4.242-4.243a1 1 0 111.415 1.414L9.364 7.95l4.243 4.242a1 1 0 11-1.415 1.415L7.95 9.364l-4.243 4.243a1 1 0 01-1.414-1.415L6.536 7.95 2.293 3.707a1 1 0 011.414-1.414L7.95 6.536z" />
                                    </svg>
                        ...
                        <!-- Modal content -->
                        <form method="post" action="{{ route('impor-rekening') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="px-5 py-4">
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-sm font-medium mb-1" for="name">File <span class="text-rose-500">*</span></label>
                                        <input type="file" name="file" id="file" class="form-input w-full px-2 py-1 @error('file') is-invalid @enderror" required>
                                        @error('file')
                                            <div class="text-xs mt-1 text-rose-500">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="px-5 py-4">
                                <div class="flex flex-wrap justify-end space-x-2">
                                    <button class="btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" @click="rekeningOpen = false">Batal</button>
                                    <button type="submit" class="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Impor</button>
                                </div>
                            </div>
                        </form>
