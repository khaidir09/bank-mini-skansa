        ...
        @if ($selectedCustomer)
            <div class="mb-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                ...
                @if ($selectedAccount)
                    ...
                    <p><strong>Saldo Saat Ini:</strong> Rp. {{ number_format($selectedAccount->saldo) }}</p>
                @else
            ...
            <div class="mb-4">
                <label for="date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Transaksi</label>
                <input type="date" wire:model="date" id="date" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                ...
                <div class="flex flex-wrap items-center -m-3">
                    <div class="m-3">
                        <label class="flex items-center">
                            <input type="radio" wire:model="jenis" class="form-radio" value="Setor"/>
                            <span class="text-sm ml-2">Setor</span>
                        </label>
                        </div>
                    <div class="m-3">
                        <label class="flex items-center">
                            <input type="radio" wire:model="jenis" class="form-radio" value="Tarik" />
                            <span class="text-sm ml-2">Tarik</span>
                        </label>
                        </div>
                </div>
                @error('jenis')
